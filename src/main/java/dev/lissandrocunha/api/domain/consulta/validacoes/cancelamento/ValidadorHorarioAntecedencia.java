...
import dev.lissandrocunha.api.domain.consulta.ConsultaRepository;
...
public class ValidadorHorarioAntecedencia implements ValidadorCancelamentoDeConsulta {
    ...
    public void validar(DadosCancelamentoConsulta dados) {
        ...
        if (diferencaEmHoras < 24) {
            throw new BusinessException("Consulta somente pode ser cancelada com antecedência mínima de 24h!");
        }
    }
}
